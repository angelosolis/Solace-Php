...
<!-- Mirrored from uiparadox.co.uk/public/templates/royalfare/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 May 2024 11:29:15 GMT -->
<head>
        <meta charset="UTF-8">
                            ...
                            <div class="ui-header-inner container-fluid"> 
                                ...
                                <div class="ui-header-col">
                                    ...
                                    <div class="ui-header-tools">
                                        ...
                                        <a href="signup.html" class="ui-header-tools-item"><i class="fa-regular fa-user"></i></a>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xxl-8 col-lg-10 offset-xxl-2 offset-lg-1">
                                        <h5 class="mb-16">Create Your Account</h5>
                                        ...
                                        <div class="text-center">
                                            <p class="fw-500 color-black">Already have an account? <a href="/login" class="color-primary text-decoration-underline"> Login</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
